...
@stop
@section('content')
<form action="respuestas/encuesta3" method="POST" class="was-validated">
    @csrf
    <div class="card">
        <div class="card-header ">
            <i class="font-weight">Para responder las preguntas siguientes considere las condiciones ambientales de su centro de trabajo.</i>
        </div>
        <div class="card-body">
